...
int buffer = 150;
// int greenValues[] = {600, 450, 500, 550, 450, 700, 600, 500, 550, 650, 550, 300, 250, 300, 250, 500};
...
//   int count = 0;
//   if (analogValues[14] > greenValues[14] + buffer) {
//     count++;
//   }
...
//   int count = 0;
//   if (analogValues[10] > greenValues[10] + buffer) {
//     count++;
//   }
...
float ColorSensor::getAvoidAngle() {
  ...
  //   result = 180;
  // }
  // if ((analogValues[13] > greenValues[13] + buffer || analogValues[12] > greenValues[12] + buffer) 
  ...
  //   result = 90;
  // }
  // if ((analogValues[1] > greenValues[1] + buffer || analogValues[0] > greenValues[0] + buffer) 
  ...
  //   result = 0;
  // }
  // if ((analogValues[4] > greenValues[4] + buffer || analogValues[5] > greenValues[5] + buffer) 
  ...
  // && (analogValues[8] > greenValues[8] + buffer || analogValues[9] > greenValues[9] + buffer)) 
  // {
